...
val _ = save_thm ("extracted_string_ind",data_to_wordTheory.extracted_string_ind |> inline_simp |> conv64)
val _ = translate (data_to_wordTheory.extracted_string_def |> inline_simp |> conv64)
...
val _ = translate(StringLitLoop_code_def|> inline_simp |> conv64)
...
val _ = translate (data_to_wordTheory.extract_strings_prog_def |>
                   SIMP_RULE std_ss [DROP_EQ_NIL] |> conv64)
val _ = translate (data_to_wordTheory.extract_strings_def |> conv64)

val _ = translate (data_to_wordTheory.strings_to_rodata_def |> inline_simp |> conv64)
